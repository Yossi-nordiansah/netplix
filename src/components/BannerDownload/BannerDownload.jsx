    ...
    <div className='sm:py-[85px] py-16 border-b-[9px] border-b-zinc-800 text-white bg-black'>
      <div className=' w-[95%] flex mx-auto justify-center flex-col-reverse lg:flex-row'>
        <div className='relative lg:mt-0 mt-12 xl:w-[45%] lg:w-[50%] w-full'>
          ...
          <div className='absolute left-1/2 sm:bottom-6 bottom-4 bg-black items-center -translate-x-1/2 sm:py-2 py-1 rounded-xl border-[3px] xl:w-[54%] lg:w-[70%] sm:w-[59%] w-[78%] flex lg:justify-center sm:justify-evenly justify-center border-zinc-600 '>
              <img src={boxshot} alt="" className='xl:w-[63px] lg:w-[17%] sm:w-12 w-9' />
              <div className='sm:ml-5 ml-2 pr-4'>
                <p className='sm:text-lg lg:text-[16px] leading-5 font-netflix xl:w-[60%] w-full'>Stranger Things</p>
                <p className='text-[#3366ff]'>Men-download...</p>
              </div>
              <img src={downloadAnimate} alt="" className='w-[50px] sm:ml-0 ml-2 h-12'/>
          </div>
        </div>
        <div className='lg:w-[60%] xl:w-[45%] w-full self-center border'>
          <h1 className='font-netflix lg:text-[54px] sm:text-[30px] text-[33px] lg:leading-[65px] lg:ml-0 md:mx-auto sm:mx-auto lg:text-left text-center sm:w-[80%] md:w-full sm:leading-[40px] leading-10 border'>Download acara TV untuk menontonnya secara offline</h1>
