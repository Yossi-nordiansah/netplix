...
const BannerStreaming = () => {
  return (
    ...
    <div className='xl:w-[75%] w-[95%] flex mx-auto justify-center gap-7 flex-col lg:flex-row border'>
        ...
        <div className='relative lg:w-1/2 lg:mx-0 mx-auto w-[90%] xl:-mt-11 mt-2 border'>
