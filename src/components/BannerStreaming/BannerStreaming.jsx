...
const BannerStreaming = () => {
  return (
    <div className='xl:py-[210px] lg:py-44 sm:pt-16 sm:pb-[600px] py-11 border-b-[9px] border-b-zinc-800 text-white bg-black'>
    <div className='xl:w-[75%] w-[90%] flex mx-auto justify-center gap-7 flex-col lg:flex-row'>
        ...
        <div className='relative lg:w-1/2 lg:mx-0 mx-auto w-[90%] xl:-mt-11 mt-2'>
            ...
            <img src={deviceimg} alt="" className='relative w-[100%] lg:-top-20'/>
        </div>
    </div>
</div>
  )
