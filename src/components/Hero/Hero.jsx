    ...
    return (
        <div className=' bg-no-repeat bg-center bg-cover border-b-zinc-800 border-b-[10px]' style={{ backgroundImage: `url(${bghero})` }}>
            <div style={bggradient} className='w-full -mb-[1px]'>
                <Navbar />
                <div className='lg:w-[75%] sm:w-[90%] w-[85%] mx-auto z-10 lg:mt-44 sm:mt-28 mt-14 lg:pb-44 sm:pb-28 pb-9'>
                    <h1 className='text-white lg:text-[54px] sm:text-4xl text-3xl sm:leading-[69px] font-bolder text-center font-netflix'>Film, acara TV tak terbatas, dan banyak lagi</h1>
                    <p className='text-center text-white lg:text-[27px] sm:text-[21px] text-[18px] font-netflixrg mt-[16px]'>Tonton di mana pun. Batalkan kapan pun.</p>
                    <p className='text-center mx-auto text-white lg:text-[22px] sm:text-[21px] text-[18px] sm:w-full w-[90%] font-netflixrg mt-[19px]'>Siap menonton? Masukkan email untuk membuat atau memulai lagi keanggotaanmu.</p>
